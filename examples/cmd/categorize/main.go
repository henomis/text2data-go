...
func main() {
	...
	requestCategorize := &request.Request{}
	requestCategorize.DocumentText = "Excellent location, opposite a very large mall with wide variety of shops, restaurants and more."

	response, err := text2dataClient.Categorize(requestCategorize)
	if err != nil {
